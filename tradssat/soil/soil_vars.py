...
vars_ = {
    ...
    FloatVar('SLU1', '', 5, 0, info='Evaporation limit, cm'),
    FloatVar('SLDR', '', 5, 2, info='Drainage rate, fraction day-1'),
    FloatVar('SLRO', '', 5, 0, info='Runoff curve number (Soil Conservation Service)'),
    ...
    FloatVar('SRGF', '', 5, 2, info='Root growth factor, 0.0 to 1.0 '),

...
_vars = {
    ...
    IntegerVar('WYEAR', 4, info=''),
    CharacterVar('SOIL_ID', 10, header_fill='.', info='Soil name'),
    FloatVar('XLAT', 16, 9, info=''),
    FloatVar('LONG', 15, 9, info=''),
    IntegerVar('ELEV', 9, info=''),
    ...
    IntegerVar('FCWAM', 7, info=''),
    IntegerVar('FHWAM', 7, info=''),
    IntegerVar('HWAHF', 7, info=''),
    IntegerVar('FBWAH', 7, info=''),
    IntegerVar('FPWAM', 7, info=''),
